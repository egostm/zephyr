...
#endif
#if DT_HAS_NODE_STATUS_OKAY(DT_NODELABEL(spi4)) && CONFIG_SPI
#ifdef CONFIG_SPI_STM32_USE_HW_SS
...
#endif
#if DT_HAS_NODE_STATUS_OKAY(DT_NODELABEL(i2s2)) && CONFIG_I2S
...
#endif
#if DT_HAS_NODE_STATUS_OKAY(DT_NODELABEL(pwm9)) && CONFIG_PWM
