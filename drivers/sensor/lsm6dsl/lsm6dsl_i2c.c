 ...
 * @code{.codegen}
 * codegen.edevice_tree_compatible_gating('st,lsm6dsl')
 * @endcode{.codegen}
 */
...
static int lsm6dsl_i2c_read_data(struct lsm6dsl_data *data, u8_t reg_addr,
				 u8_t *value, u8_t len)
{
	return i2c_burst_read(data->comm_master, data->i2c_addr,
			      reg_addr, value, len);
}
...
static int lsm6dsl_i2c_write_data(struct lsm6dsl_data *data, u8_t reg_addr,
				  u8_t *value, u8_t len)
{
	return i2c_burst_write(data->comm_master, data->i2c_addr,
			       reg_addr, value, len);
}
...
static int lsm6dsl_i2c_read_reg(struct lsm6dsl_data *data, u8_t reg_addr,
				u8_t *value)
{
	return i2c_reg_read_byte(data->comm_master, data->i2c_addr,
				 reg_addr, value);
}
...
{
	return i2c_reg_update_byte(data->comm_master, data->i2c_addr,
				   reg_addr, mask, value);
}
